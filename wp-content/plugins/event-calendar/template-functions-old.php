...
{
  global $ec3;
  echo "<table class='nav' width='100%'><tbody><tr>\n";

  // Previous
  $prev=$date->prev_month();
  echo "\t<td id='prev' width='15' align='left'><a id='ec3_prev' href='" . $prev->month_link() . "' style='text-decoration:none; font-size:14px;'>&lt;</a></td>\n";
  ...
  echo "\t<td id='next' width='15' align='right'><a id='ec3_next' href='" . $next->month_link() . "' style='text-decoration:none; font-size:14px;'>&gt;</a></td>\n";
...
function ec3_get_calendar_month($date,$calendar_days,$thead)
{
  ...
  echo "<div style='width:160px; margin:0 20px; margin-top:-18px; margin-bottom:10px; text-align:center;'>" . $date->month_name() . " " .$date->year_num . "</div>\n";
