...
{
  global $ec3;
  echo "<table class='nav tabledatesnav' width='200' cellpadding='0' cellspacing='0'><tbody><tr>\n";

  // Previous
  $prev=$date->prev_month();
  echo "\t<td id='prev' width='15' align='left'><a id='ec3_prev' href='" . $prev->month_link() . "'"
  ...
  echo "\t<td id='next' width='11' align='right'><a id='ec3_next' href='" . $next->month_link() . "'"
...
function ec3_get_calendar_month($date,$calendar_days,$thead)
{
  ...
  echo "<table id='" . $date->month_id() . "' class='tabledates'>\n<caption>"
