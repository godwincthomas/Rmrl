...
<div class="wrap">
	...
	<form style="float: right;" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_donations">
						<input type="hidden" name="business" value="EB45GHFZXRK5Q">
						<input type="hidden" name="lc" value="US">
						<input type="hidden" name="item_name" value="ARScode Social Slider">
						<input type="hidden" name="item_number" value="ARScode">
	...
	<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
		...
		<div style="text-align: left;">
			...
			<a href="http://codecanyon.net/item/facebook-likebox-slider-for-wordpress-/1021632?ref=arscode" target="_blank"><img border="0"  src="<? echo plugins_url('/img/get-pro-button.png', __FILE__) ?>" /></a>
			<br />
			<a href="http://themeforest.net/?ref=arscode" target="_blank"><img border="0"  src="<? echo plugins_url('/img/tf_300x250_v4.gif', __FILE__) ?>" /></a>
			</div>
		</div>
		<div id="fb-root"></div>
